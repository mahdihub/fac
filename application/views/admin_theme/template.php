...
<head>
  ...
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?=base_url('assets/admin_lte/bower_components/jvectormap/jquery-jvectormap.css')?>">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?=base_url('assets/admin_lte/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')?>">
  <!-- Daterange picker -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a  href="<?= site_url('adminsc/articles_non_valides')?>" >
            <i class="fa fa-th"></i> <span>articles non valides</span>
            
            <div id="anv-notif" class="label label-success"></div>
          </a>
        </li>        
        
        <li>
          <a  href="<?= site_url('adminsc/articles')?>">
            <i class="fa fa-th"></i> <span>articles</span>
          </a>
        </li>
 
        <li>
          <a  href="<?= site_url('adminsc/categories')?>">
            <i class="fa fa-th"></i> <span>categories</span>
          </a>
        </li>
              
        <li>
          <a href="<?= site_url('adminsc/admins')?>">
            <i class="fa fa-th"></i> <span>admins</span>
          </a>
        </li>
                        
        <li>
          <a  href="<?= site_url('adminsc/users')?>">
  ...
  <div class="content-wrapper">
   ...
   <div id="table">                                      <!--<<<<<< affichage de  la table-->
        <?=$content_for_layout?>
    </div>
</div>
 </div>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?=base_url('assets/admin_lte/bower_components/jquery-ui/jquery-ui.min.js')?>"></script>
...
<!-- Sparkline -->
<script src="<?=base_url('assets/admin_lte/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js')?>"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="<?=base_url('assets/admin_lte/bower_components/jquery-knob/dist/jquery.knob.min.js')?>"></script>
<!-- daterangepicker -->
...
<!-- datepicker -->
<script src="<?=base_url('assets/admin_lte/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')?>"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?=base_url('assets/admin_lte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')?>"></script>
<!-- Slimscroll -->
<script src="<?=base_url('assets/admin_lte/bower_components/jquery-slimscroll/jquery.slimscroll.min.js')?>"></script>
<!-- FastClick -->
<script src="<?=base_url('assets/admin_lte/bower_components/fastclick/lib/fastclick.js')?>"></script>
<!-- AdminLTE App -->
